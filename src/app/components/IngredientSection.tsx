...
const IngredientSection = () => {
  ...
  const isIngredientSelected = recipe.selectedAction.type === "ingredient";
  ...
  return (
    <ul className="space-y-2">
      {recipe.ingredients.map((ingredient, index) => {
        const isSelected =
          isIngredientSelected && recipe.selectedAction.index === index;
        ...
        return (
          <li
            key={ingredient.id}
            onClick={(e) => {
              dispatch(setSelectedAction({ index, type: "ingredient" }));
            }}
